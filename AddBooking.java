    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ...
                BookingList bookingList = new BookingList();  //  Create one shared BookingList
                bookingList.readFile();                       // Load existing bookings from file
                new AddBooking(auth, bookingList).setVisible(true); // Use correct constructor
            }
        });
    }
